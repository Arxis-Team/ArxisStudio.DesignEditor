...
`DesignSpacingResolver` ставит элемент так, чтобы зазоры до ближайших соседей по оси стали равны, и показывает оба зазора отрезками с засечками. Арифметика вынесена туда же, куда и выравнивание, и по той же причине: соседи приходят готовыми прямоугольниками, редактора и дерева резолвер не знает.
