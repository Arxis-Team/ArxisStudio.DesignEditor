...
Лицензия — MIT, задана SPDX-выражением `PackageLicenseExpression`, а не файлом: для стандартной лицензии это рекомендованный способ, и NuGet сам подставляет ссылку. Файл `LICENSE` в корне остаётся для людей и для GitHub.
