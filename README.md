...
2. Настройка внешнего вида направляющих сверх цвета и толщины: штриховая линия, свой цвет для выравнивания по центру и по краю. Слой отрисовки пока `internal` — публиковать его имеет смысл под конкретное требование.
