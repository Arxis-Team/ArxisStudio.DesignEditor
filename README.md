...
Когда элемент подводят к положению, при котором зазоры до соседей слева и справа (или сверху и снизу) равны, он встаёт на него, а оба зазора показываются отрезками с засечками — это измерение, а не ещё одна ось.
...
1. Замена слоя направляющих целиком. Цвет, толщина, штрих и разный цвет по виду выравнивания уже настраиваются ресурсами; слой отрисовки пока `internal` — публиковать его имеет смысл под конкретное требование.
