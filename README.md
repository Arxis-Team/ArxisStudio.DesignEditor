...
Изменение размера направляющими пока не пользуется.

| Ресурс | Назначение |
|---|---|
| `DesignEditor.SnapGuideBrush` | цвет направляющих |
...
1. Пользовательские направляющие — линейки и вытягиваемые guides, к которым тоже идёт привязка.
2. Направляющие при изменении размера: сейчас выравнивание работает только на перетаскивании.
3. Подсказки о равных интервалах между соседями.
4. Настройка внешнего вида направляющих сверх цвета и толщины: штриховая линия, свой цвет для выравнивания по центру и по краю. Слой отрисовки пока `internal` — публиковать его имеет смысл под конкретное требование.
