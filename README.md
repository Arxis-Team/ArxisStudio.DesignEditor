...
| Ресурс | Назначение |
|---|---|
| `DesignEditor.SnapGuideBrush` | цвет направляющих выравнивания |
...
Правила притяжения общие с направляющими выравнивания, включая «направляющая сильнее сетки на занятой оси» и обход по `SnapBypassModifiers`. Создать линию мышью пока нельзя — линеек и вытягивания нет, см. roadmap.
...
1. Линейки и вытягивание направляющих мышью. Сама модель уже есть — `Guides` задаётся снаружи, притягивает и рисуется; нет способа поставить линию указателем, а также подвинуть и убрать поставленную.
2. Подсказки о равных интервалах между соседями.
3. Настройка внешнего вида направляющих сверх цвета и толщины: штриховая линия, свой цвет для выравнивания по центру и по краю. Слой отрисовки пока `internal` — публиковать его имеет смысл под конкретное требование.
